...
function motopressCERolesSettingsFields(){
    ...
    echo '<p class="description">' . strtr($motopressCELang->CEOptRolesSettingsDescription, array('%BrandName%' => $motopressCESettings['brand_name']))  . '</p>';
}
...
function motopressCEGoogleFontsFields() {
    ...
    if (!isset($error['error'])) {
        ...
        echo '<button class="mp-create-google-font-class-entry">' . $motopressCELang->CEOptGoogleFontsCreateClass . '</button>';
        
        echo '<p class="description mp-google-font-custom-style-desc">'.$motopressCELang->CEOptGoogleFontsCustomClassNameDesc .'</p>';
...
?>
    <div class="wrap">
        ...
        <?php $linkHowToPersonalAccount = apply_filters('mpce_link_howto_personal_account', 'https://motopress.zendesk.com/hc/en-us/articles/202812996-How-to-use-your-personal-MotoPress-account');?>
        <i><?php echo str_replace('%link%', esc_url($linkHowToPersonalAccount), $motopressCELang->CELicensePageNotice); ?></i>        
