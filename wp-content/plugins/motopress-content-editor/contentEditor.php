        ...
        <div class="motopress-content-editor-navbar">
            <div class="navbar-inner">
                <div id="motopress-logo">
                    <?php $logoSrc = apply_filters('mpce_logo_src', $motopressCESettings['plugin_root_url'].'/'.$motopressCESettings['plugin_name'].'/images/logo.png?ver='.$motopressCESettings['plugin_version']);?>
